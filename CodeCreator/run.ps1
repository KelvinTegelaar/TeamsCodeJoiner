...
if ($Request.method -eq "POST") {
    $randomID = (1..5 | ForEach-Object { Get-Random -Minimum 0 -Maximum 9 } ) -join ''
    ...
    $Message = "Enter the URL you wish to create a join code for."
}
...
<body>
<center>
<title>Quick Teams Joiners</Title>
<h3>Generate a Teams Quick Join URL</h3>
<br>
<b>$Message</b></br>
<div>
  ...
  <form action="Create" method=POST>
    <label for="TeamsURL">Teams URL</label><br>
    <input type="text" id="TeamsURL" name="TeamsURL"><br>
